...
dbLinkBudget.define_table('SAT',
                          ...
                          Field('NORMAL_VECT_Z','double')) #From a quick search online the IS_IN_DB function can't be in a list otherwise it won't
...
dbLinkBudget.define_table('Job',
                          ...
                          Field('comp_gw_cover','boolean',label='5) Compute geometric parameters for Earth gateways (Gateway)'),
                          Field('propa_feeder_link','boolean',label='6) Compute propagation on Feeder Link (Gateway)'),
                          ...
                          Field('csi0_up_flag','string', requires=IS_IN_SET(('To Compute', 'From File','Disregard')),default='Disregard',label='b) C/I0up'),
                          Field('csim0_flag','string', requires=IS_IN_SET(('To Compute', 'From File','Disregard')),default='Disregard',label='c) C/Im0'),
                          Field('csn0_dn_flag','string', requires=IS_IN_SET(('To Compute', 'From File','Disregard')),default='Disregard',label='d) C/N0dn'),
                          Field('csi0_dn_flag','string', requires=IS_IN_SET(('To Compute', 'From File','Disregard')),default='Disregard',label='e) C/I0dn'),
