...
dbLinkBudget.define_table('SAT',
                          Field('Job_ID', requires=IS_IN_DB(dbLinkBudget, 'Job.id'),  label = 'Scenario ID', readable = False),
                          ...
                          Field('FOV_RADIUS', 'double', requires=IS_NOT_EMPTY(), label = 'Field of View Half Angle (deg)'),
                          ...
                          Field('PAYLOAD_ID', 'double', requires=IS_IN_DB(dbLinkBudget, dbLinkBudget.TRSP.PAYLOAD_ID), readable = False),
                          ...
                          Field('NORMAL_VECT_Z', 'double', readable = False))  # From a quick search online the IS_IN_DB function can't
...
dbLinkBudget.define_table('Earth_coord_GW',
                          ...
                          Field('AVAILABILITY_UP', 'double', requires=IS_NOT_EMPTY(), readable = False),
                          Field('AVAILABILITY_DN', 'double', requires=IS_NOT_EMPTY(), readable = False),
                          Field('SAT_ID', 'double', requires=IS_IN_DB(dbLinkBudget, dbLinkBudget.SAT.SAT_ID), readable = False),
                          Field('PAYLOAD_ID', 'double', requires=IS_IN_DB(dbLinkBudget, 'TRSP.PAYLOAD_ID'), readable = False),
                          Field('TRSP_ID', 'double', requires=IS_IN_DB(dbLinkBudget, dbLinkBudget.TRSP.TRSP_ID), readable = False),
                          Field('GW_ID', 'string', requires=IS_IN_DB(dbLinkBudget, 'Gateway.GW_ID')),
                          Field('POS_X_ECEF', 'double', readable = False),
                          Field('POS_Y_ECEF', 'double', readable = False),
                          Field('POS_Z_ECEF', 'double', readable = False),
                          Field('SAT_POS_X_ECEF', 'double', readable = False),
                          Field('SAT_POS_Y_ECEF', 'double', readable = False),
                          Field('SAT_POS_Z_ECEF', 'double', readable = False),
                          Field('DIST', 'double', readable = False),
                          Field('ELEVATION', 'double', readable = False),
                          Field('NADIR_X_ECEF', 'double', readable = False),
                          Field('NADIR_Y_ECEF', 'double', readable = False),
                          Field('NADIR_Z_ECEF', 'double', readable = False),
                          Field('NORMAL_VECT_X', 'double', readable = False),
                          Field('NORMAL_VECT_Y', 'double', readable = False),
                          Field('NORMAL_VECT_Z', 'double', readable = False),
                          Field('ROLL', 'double', readable = False),
                          Field('PITCH', 'double', readable = False),
                          Field('YAW', 'double', readable = False),
                          Field('AZ_SC', 'double', readable = False),
                          Field('ELEV_SC', 'double', readable = False),
                          Field('CENTRAL_FQ_DN', 'double', readable = False),
                          Field('FSL_DN', 'double', readable = False),
                          Field('POLAR', 'string', requires=[IS_IN_SET(('C', 'CC')), IS_NOT_EMPTY()], readable = False),
                          Field('DIAMETER', 'double', readable = False),
                          Field('EFFICIENCY', 'double', readable = False),
                          Field('POLAR_TILT_ANGLE', 'double', readable = False),
                          Field('PROPAG_DN', 'double', readable = False),
                          Field('BEAM_TX_CENTER_X_ANT', 'double', readable = False),
                          Field('BEAM_TX_CENTER_Y_ANT', 'double', readable = False),
                          Field('BEAM_TX_CENTER_Z_ANT', 'double', readable=False),
                          Field('BEAM_TX_ANT_DIAM', 'double', readable = False),
                          Field('BEAM_TX_TYPE', 'string', readable = False),
                          Field('MAX_GAIN_TX', 'double', readable = False),
                          Field('BEAM_TX_THETA_3DB', 'double', readable = False),
                          Field('SAT_GAIN_TX', 'double', readable = False),
                          Field('IBO', 'double', readable = False),
                          Field('AMP_SAT', 'double', readable = False),
                          Field('OBO', 'double', readable = False),
                          Field('SAT_EIRP', 'double', readable = False))
