...
dbLinkBudget.define_table('SAT',
                          ...
                          Field('NADIR_X_ECEF','double',requires=IS_NOT_EMPTY()),
                          Field('NADIR_Y_ECEF','double',requires=IS_NOT_EMPTY()),
                          Field('NADIR_Z_ECEF','double',requires=IS_NOT_EMPTY()),
                          Field('SAT_POS_X_ECEF','double',requires=IS_NOT_EMPTY()),
                          Field('SAT_POS_Y_ECEF','double',requires=IS_NOT_EMPTY()),
                          Field('SAT_POS_Z_ECEF','double',requires=IS_NOT_EMPTY()),
                          Field('NORMAL_VECT_X','double',requires=IS_NOT_EMPTY()),
                          Field('NORMAL_VECT_Y','double',requires=IS_NOT_EMPTY()),
                          Field('NORMAL_VECT_Z','double',requires=IS_NOT_EMPTY())) #From a quick search online the IS_IN_DB function can't be in a list otherwise it won't
