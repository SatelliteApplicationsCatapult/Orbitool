...
#ax.quiver(nadir_ecef[0],nadir_ecef[1],nadir_ecef[2],normal_vector[0],normal_vector[1],normal_vector[2], length=1000, color = 'r')
#ax.quiver(nadir_ecef[0],nadir_ecef[1],nadir_ecef[2],normal_vector2[0],normal_vector2[1],normal_vector2[2], length=1000, color = 'g')
